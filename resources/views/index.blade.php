...
<body id="body-pd">
    <header class="header" id="header">
        ...
        <button style="margin-left: auto; margin-right: 0.5rem; border:none;background-color: #F7F6FB;"
       >{{adminUser()->Ten}}</button>
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            ...
            <a href="{{route('logout')}}" class="nav_link"> <i class='bx bx-log-out nav_icon'></i> <span class="nav_name">SignOut</span>
            </a>
        </nav>
